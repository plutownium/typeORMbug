...
import { EmailDetails } from "../interface/EmailDetails.interface";

class EmailService {
    private emailSender: Function;
    private testingMode: boolean | undefined;
    public emailSenderReached: Function = (args: EmailDetails) => {};

    constructor(sendEmail: Function, testing?: string) {
        this.testingMode = testing === "testing"; // safeguard to prevent accidentally setting to testing mode
        this.emailSender = sendEmail;
    }

    // public async sendVerificationEmail(account: Account, origin: string) {
    //     let message;
